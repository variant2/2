...
jQuery(function ($) {
    ...
    if (!$.browser.msie || parseInt($.browser.version, 10) > 8)
        return;
    var path = "";
    var scripts = $("script[src*='script.js'/*tpa=http://mmaster.net.ua/wp-content/themes/mmasterdoctor/script.js*/]");
    if (scripts.length > 0) {
        var src = scripts.last().attr('src');
        path = src.substr(0, src.indexOf("script.js"/*tpa=http://mmaster.net.ua/wp-content/themes/mmasterdoctor/script.js*/));
    }
